...
public class President {
    ...
    public static Comparator<President> PresidentNameDateAscendingComparator = new Comparator<President>() {
        @Override
        public int compare(President p1, President p2) {
    ...
    public static Comparator<President> PresidentNameDateDescendingComparator = new Comparator<President>() {
        @Override
        public int compare(President p1, President p2) {
    ...
    public int getDateOfElection() { return dateOfElection; }
    public void setDateOfElection(int dateOfElection) { this.dateOfElection = dateOfElection; }
